...
class DatabaseUtil {
    ...
    static func deleteAllManagedObjects () {
        ...
        do {
            ...
            deleteRequest = NSBatchDeleteRequest(fetchRequest: episodeRequest as! NSFetchRequest<NSFetchRequestResult>) // swiftlint:disable:this force_cast
            try DatabaseUtil.getContext().execute(deleteRequest)
        } catch let error as NSError {
    ...
    static func getEpisode (_ episodeTitle: String?) -> Episode? {
        ...
        if (episodeTitle != nil) {
            request.predicate = NSPredicate(format:"title = %@", episodeTitle as! CVarArg) // swiftlint:disable:this force_cast
        }
    ...
    static func getEpisodesByPodcastTitle (_podcastTitle: String?) -> [Episode?] {  // swiftlint:disable
        let episodeRequest: NSFetchRequest<Episode> = Episode.fetchRequest()
        episodeRequest.predicate = NSPredicate(format:"title = %@", _podcastTitle as! CVarArg) // swiftlint:disable:this force_cast
        do {
